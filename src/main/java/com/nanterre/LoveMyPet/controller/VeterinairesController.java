...
public class VeterinairesController {
    ...
    public List<Veterinary> getVeterinaires(
        ...
        String overpassApiUrl = "https://overpass-api.de/api/interpreter?data=[out:json];(node[\"amenity\"=\"veterinary\"](around:" + radius + "," + latitude + "," + longitude + "););out;";
